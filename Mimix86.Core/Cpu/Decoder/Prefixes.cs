...
public static class Prefixes
{
    ...
    /// <summary>
    /// Contains the various one-byte x86 instruction prefixes that are supported.
    /// </summary>
    public enum OneByte
    {
        /// <summary>
        ...
        /// This is also overloaded by the Pentium P4 as a "hint branch taken" for <c>Jcc</c>, and for Intel CET to
        ///   suppress the check for <c>ENDBR32</c> or <c>ENDBR64</c> at an indirect branch target.
        /// </summary>
        SegmentSS,
        ...
        ///   <see cref="Evex" />.
        /// Since the introduction of Intel APX in July 2023, this is no longer true, with the "U" bit being overloaded
        ...
        /// </summary>
        /// <remarks>
        /// Despite originally being the same as the <see cref="Mvex" /> prefix, but with the "U" bit being set, Intel
        ///   APX has changed this;
    ...
    /// <summary>
    /// Contains the various two-byte x86 instruction prefixes that are supported.
    /// These are all values that must occur immediately after <see cref="OneByte.TwoByteEscape" />.
    /// </summary>
    public enum TwoByte
    {
        /// <summary>
